unit trideni;    {pro jednotku je tento radek povinny}
interface
...
procedure selectsort(var pole:mojepole);   {tyhle tri maji byt videt}
procedure quicksort(var pole:mojepole);
procedure bubblesort(var pole:mojepole);


implementation       {zacatek implementace, konci end.}
