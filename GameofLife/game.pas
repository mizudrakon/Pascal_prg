...
var     field : twod;
        stop:boolean;                 //stop is used to stop the program by appropriate input
...
procedure parse(var s:integer;a:integer); //used to make sense of short user input required as instructions
var     h:string;
        n,i:integer;
...
begin
   ...
   begin
      ...
      s:=10*s+n;
      inc(i);
      if (s<1) or (s>a) then    //also the number must not be greater then specified ceiling
      begin
